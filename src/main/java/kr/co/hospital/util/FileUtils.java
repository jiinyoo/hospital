...
public class FileUtils {
	...
	public static String getFileName1(String fname,String str) throws Exception
	{
		File ff=new File(str);
		while(ff.exists())  // a1.jpg
		{
			...
			str=ResourceUtils.getFile("classpath:static/admin/doctor").toPath().toString()+"/"+newFname;

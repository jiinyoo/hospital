...
<div class="container">
    ...
    <div class="section location" id="menu4">
        <h2>주차 안내</h2>
        <p>
            장인호 병원은 병원을 방문하는 환자분들을 위해 넓은 주차 공간을 제공합니다. 환자와 보호자가 편리하게 주차할 수 있도록 병원 내외에 주차 시설을 마련하였으며, 주차 요금은 무료로 제공됩니다.
        </p>
        <p>
            주차 시설은 24시간 개방되어 있으며, 병원 내 안내 데스크에서 주차 관련 안내를 받을 수 있습니다. 추가로 병원 인근의 주차장 정보도 제공해 드리니, 언제든지 편리하게 이용해 주세요.
        </p>
        <div class="contact-info">
            <p>주차장 주소: 경기도 고양시 마두동 병원로 123</p>
            <p>주차 관련 문의: 031-123-4567</p>
        </div>
        <!-- 주차장 이미지 -->
        <img src="/static/client/info/parking.jpg" style="height:600px;" alt="장인호 병원 주차장 안내">
    </div>

    <!-- 오시는 길 섹션 -->
    <div class="section location" id="menu5">
        <h2>오시는 길</h2>
        <p>
